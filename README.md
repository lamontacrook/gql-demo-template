...
* Go to <https://github.com/adobe/gql-demo-template/releases/latest> and download `gql-demo-template-{version}.zip`
* Upload `gql-demo-template-{version}.zip` in AEMaaCS's site creation wizard to create a new site from that template.

## Build locally

Alternatively you can build `gql-demo-template-{version}.zip` locally.
...
1. The site template ZIP file is now located below the template root: `gql-demo-template-{version}.zip`.
...
* Commit, build and release latest Site Theme related changes in [Site Theme E2E Repo](https://github.com/adobe/gql-demo-template-theme-e2e).
